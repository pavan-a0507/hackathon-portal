...
// ShieldCheck is added to indicate an administrative section
import { Home, LayoutDashboard, TrendingUp, Award, ShieldCheck } from "lucide-react";
            ...
            <div className="container mx-auto px-4">
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="flex gap-1">
                        ...
                        <NavLink
                            to="/admin"
                            className="px-4 py-2 rounded-md flex items-center gap-2 text-sm font-medium transition-colors hover:bg-destructive/10"
